...
```
the **mean** of the total number of steps taken per day is `r showmean` steps
the **median** of the total number of steps taken per day is `r showmedian` steps
...
```
The interval `r int` has the maximum average number of steps.
...
There are `r nb` rows contain the `NA` value.
...
```
the **mean** of the total number of steps taken per day(NA replaced) is `r showmean2` steps  

the **median** of the total number of steps taken per day(NA replaced) is `r showmedian2` steps  
